...
> 最后更新：2026-06-15（基于 develop 分支代码重新生成 5 个物料文档）
...
> 五个物料都基于 **`develop` 分支当前代码**（2026-06-15 commit）生成，与 `release` 分支的兼容代码已剥离。
