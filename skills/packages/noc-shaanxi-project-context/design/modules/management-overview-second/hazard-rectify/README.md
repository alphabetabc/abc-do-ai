...
- **表格 10 列**（真实 dataIndex，同 risk-detail 契约字段）：序号 + hiddenDangerSerialNo / hiddenDangerType / hiddenDangerSubType / hiddenDangerName / major / hiddenDangerLevel / handleDept / resourceName / solveSchedule / rectifyPlanClassify。列定义内联在 `useMemo` 中。
