...
//
// 本 skill 托管的文件（见 SKILL.md「托管的文件」）：
//   - AGENTS.md       仓库根 AI Agent / 贡献者约定
//   - .pnpmfile.cjs   仓库根 pnpm 依赖 patch（hooks.readPackage）
//
// 用法：
...
// 仓库根 = 脚本所在目录往上 4 层
// scripts/ -> oss-demonstrate-project-context/ -> skills/ -> .trae/ -> 仓库根
const REPO_ROOT = path.resolve(__dirname, "..", "..", "..", "..");
const ENV_DIR = path.resolve(__dirname, "..", "env");

// 要建立 symlink 的文件清单（相对仓库根的路径）
// 新增 / 移除时请同步更新 SKILL.md「托管的文件」表格。
const TARGETS = ["AGENTS.md", ".pnpmfile.cjs"];
