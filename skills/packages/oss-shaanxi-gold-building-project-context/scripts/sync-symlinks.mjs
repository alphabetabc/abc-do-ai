...
//
// 角色：
//   把 skill 内的 `env/AGENTS.md` 链接到项目 `.trae/AGENTS.md`，
...
const ENTRIES = [
  { sourceRel: "env/AGENTS.md", targetDir: ".trae", name: "AGENTS.md" },
  { sourceRel: "env/.pnpmfile.cjs", targetDir: ".", name: ".pnpmfile.cjs" },
];
...
Entries (fixed, per project convention):
  env/AGENTS.md       -> <target>/.trae/AGENTS.md
